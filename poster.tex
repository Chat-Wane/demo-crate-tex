\documentclass[a1paper, fontscale=0.4, portrait]{baposter}
...
\begin{poster}{
  ...
  {name=objective, column=0, span=3, below=context}{ %height=\FIRSTROW} {%, below=context} {
  ...
  \headerbox{\textsc{Crate}}
  {name=crate, column=3, span=3, height=0.2815}{ %below=objective}{ %% height=\FIRSTROW}{    
    \begin{center}
...
%%    The earth globe shows the connection status.\\
...
%%    it -- as long as a sharer exists. 
  ...
  \headerbox{\textsc{Crate's Architecture}}
...
%    \footnotesize
  ...
  \headerbox{\textsc{Editing Session WWW}}
