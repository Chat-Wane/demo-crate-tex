...
\begin{abstract}
  ...
  \CRATE only require browsers to support collaboration, raises no
  privacy issue and handle transparently small groups to large groups
  of users. Consequently, \CRATE is not restricted to traditional
  collaborative editing but can also be used in massive online
  ...
  pay the price of large networks. This paper describes \CRATE and its
  properties. It proposes a live experiment where \CRATE will be
  deployed on the large group of WWW2016 participants. We aim to
  collect a real-world editing corpus to validate results obtained in
  lab.
\end{abstract}
